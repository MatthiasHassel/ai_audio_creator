...
class ScriptEditorView(ctk.CTkFrame):
    ...
    def create_toolbar(self):
        ...
        toolbar.grid_columnconfigure(5, weight=1)  # Push buttons to the left
        ...
        self.load_button.grid(row=0, column=4, padx=2)

    def create_text_area(self):
        self.text_area = tk.Text(self, wrap=tk.WORD, undo=True)
        self.text_area.grid(row=1, column=0, sticky="nsew", padx=5, pady=2)
